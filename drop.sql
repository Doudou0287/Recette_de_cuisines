...
drop table Qualite  cascade constraint;
drop table Img_vid cascade constraint;
drop table Etape cascade constraint;
-------------------------------------
drop table Ingrediant cascade constraint;
drop table Recette cascade constraint;
